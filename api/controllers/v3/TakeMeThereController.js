    ...
    Outlet.find({'outletId': [fromOutletID, toOutletID]})
      ...
      .spread(function (outletArray, hubTransitArray, allOutletsArray) {
        ...
        if (floor1 != floor2) {
          ...
          var esc1nearbyOutletName ="";
          var escName1 ="";
          var esc2 = null;
          if(esc1 !=undefined){
            esc1nearbyOutletName = _.find(allOutletsArray, {outletID: esc1.nearbyOutlet1ID}).outletName;
            escName1 = esc1.escalatorName;
          ...
          if(esc1nearbyOutletName !=undefined && esc1nearbyOutletName ==="")
          {
            esc1nearbyOutletName  = allOutletsArray[_.findIndex(allOutletsArray, {outletID: closestBridge.nearbyOutlet1ID})].outletName;
          }
          // If it still undefined, then set as empty.
          if(esc1nearbyOutletName ==undefined){
            esc1nearbyOutletName="";
          }
